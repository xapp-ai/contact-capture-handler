...
export interface ContactCaptureData extends QuestionAnsweringData, Pick<FormResponseProps, "enablePreferredTime" | "turnOffFirstAvailableDay" | "showFirstAvailableDay" | "preferredTimeOptions" | "preferredTimeSchedule" | "preferredDateConfirmationText" | "firstPageInputType" | "showFirstPageMessage" | "serviceSelectionTitle" | "preferredTimeNotification"> {
    /**
